...
describe('padZerosToFixed()', () => {
    ...
    test('nothing to pad, leave untouched', () => {
        expect(padZerosToFixed('12.000000', 3)).toEqual('12.000000');
        expect(padZerosToFixed('12.123456', 3)).toEqual('12.123456');
        expect(padZerosToFixed('-12.000000', 3)).toEqual('-12.000000');
        expect(padZerosToFixed('-12.123456', 3)).toEqual('-12.123456');
        expect(padZerosToFixed('0.000000', 3)).toEqual('0.000000');
        expect(padZerosToFixed('0.123456', 3)).toEqual('0.123456');
    });
});
